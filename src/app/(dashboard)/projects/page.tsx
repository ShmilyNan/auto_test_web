    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">管理测试项目和 API 接口</p>
        </div>
      ...
      {projectsData && projectsData.pages > 1 && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            共 {projectsData.total} 条记录，第 {projectsData.page} /{" "}
            {projectsData.pages} 页
          </div>
          <div className="flex gap-2">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setPage((p) => Math.min(projectsData.pages, p + 1))
              }
